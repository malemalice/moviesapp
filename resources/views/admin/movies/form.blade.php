<div class="col-md-12">
    <div class="form-group margin-b-5 margin-t-5{{ $errors->has('name') ? ' has-error' : '' }}">
        ...
        <input type="text" class="form-control" name="name" placeholder="Name" value="{{ old('name', $record->name) }}" required autocomplete="off">
...
<div class="col-md-12">
    <div class="form-group margin-b-5 margin-t-5{{ $errors->has('genre_id') ? ' has-error' : '' }}">
        ...
        {{
            Form::select('genre_id', $resourceData['optGenre'],old('genre_id', $record->genre_id),['placeholder'=>'Please Select','class'=>'form-control select2'])
...
<div class="col-md-12">
    <div class="form-group margin-b-5 margin-t-5{{ $errors->has('date_released') ? ' has-error' : '' }}">
        ...
        <div class="input-group">
            ...
            value="{{ old('date_released', $record->date_released) }}"
            required
            autocomplete="off">
