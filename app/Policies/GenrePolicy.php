...
class GenrePolicy
{
     ...
     *
     * @param  \App\User  $user
     * @param  \App\Models\Genre  $record
     * @return mixed
     */
    public function view(User $user, Genre $record)
    {
        return $user->isAdmin();
    }
     ...
     * @return mixed
     */
    public function update(User $user, Genre $record)
    {
        return $user->isAdmin();
    }
     ...
     * @return mixed
     */
    public function delete(User $user, Genre $record)
    {
        return $user->isAdmin();
    }
}
